...
{
	static List<NGUIRoot> mRoots = new List<NGUIRoot>();

	/// <summary>
	/// List of all NGUIRoots present in the scene.
	/// </summary>

	static public List<NGUIRoot> list { get { return mRoots; } }
	...
	/// <summary>
	/// Type of scaling used by the NGUIRoot.
	/// </summary>
	...
	//[System.Obsolete("Use NGUIRoot's scalingStyle property instead")]
	...
	void Start ()
	{
		...
		if (oc != null)
		{
			Debug.LogWarning("NGUIRoot should not be active at the same time as NGUIOrthoCamera. Disabling NGUIOrthoCamera.", oc);
