...
public class NGUILabel : NGUIWidget
{
	...
	[HideInInspector][SerializeField] NGUIFont mFont;
	[HideInInspector][SerializeField] string mText = "";
    [HideInInspector][SerializeField] int mFontsize = -1024;
	...
	[HideInInspector][SerializeField] NGUIFont.SymbolStyle mSymbols = NGUIFont.SymbolStyle.Uncolored;
	...
	//add chiuan
	private EmojiSpriteLabel mEmojiSpriteLabel = null;
	[HideInInspector][SerializeField]public bool mIsUsedEmojiSprite = false;
	public bool isUsedEmojiSprite
	{
		get
		{
			return mIsUsedEmojiSprite;
		}	
		set
		{
			mIsUsedEmojiSprite = value;
			if(mIsUsedEmojiSprite && mEmojiSpriteLabel == null)
			{
				mEmojiSpriteLabel = EmojiSpriteLabel.create(this);
			}
			else if(mIsUsedEmojiSprite == false && mEmojiSpriteLabel != null)
			{
				mEmojiSpriteLabel.destroy();
				mEmojiSpriteLabel = null;
			}
		}
	}
	
	public EmojiSpriteLabel emojiSpriteLabel
	{
		get{return mEmojiSpriteLabel;}
	}
	...
	float mOriLinewidth = 0;
	public float LineWidthBase {get{return mOriLinewidth;}}
	...
	public NGUIFont.SymbolStyle symbolStyle
	{
		get
		{
			return mSymbols;
	...
	protected override void OnStart ()
	{
        ...
        if (fontSize == -1024)
        {
            //need to fix the lagacy mFontsize
            mFontsize = Mathf.FloorToInt(cachedTransform.localScale.x);
        }
        MakePixelPerfect();
	}
