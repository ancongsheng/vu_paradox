...
public abstract class NGUIWidget : MonoBehaviour
{
	...
	NGUIGeometry mGeom = new NGUIGeometry();
	...
	{
#if UNITY_EDITOR
		if (GetComponents<NGUIWidget>().Length > 1)
		{
	...
	public bool UpdateGeometry (NGUIPanel p, ref Matrix4x4 worldToPanel, bool parentMoved, bool generateNormals)
	{
