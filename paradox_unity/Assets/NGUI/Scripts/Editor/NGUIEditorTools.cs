...
public class NGUIEditorTools
{
	...
	static public GameObject SelectedRoot (bool createIfMissing)
	{
		...
		if (createIfMissing && go == null)
		{
			...
			if (go == null) go = NGUICreateNewUIWizard.CreateNewUI();
		}
		return go;
	}
	...
	static public void SpriteField (string fieldName, NGUIAtlas atlas, string spriteName,
	...
	static public void SpriteField (string fieldName, NGUIAtlas atlas, string spriteName, SpriteSelector.Callback callback)
	{
