...
/// <summary>
/// Inspector class used to edit NGUIPopupLists.
/// </summary>

[CustomEditor(typeof(NGUIPopupList))]
public class NGUIPopupListInspector : Editor
{
	NGUIPopupList mList;
	...
	{
		RegisterUndo();
		mList.atlas = obj as NGUIAtlas;
	}
	
	void OnSelectFont (MonoBehaviour obj)
	{
		RegisterUndo();
		mList.font = obj as NGUIFont;
	}
