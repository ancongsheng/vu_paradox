...
public abstract class NGUITweener : IgnoreTimeScale
{
	public enum Method
	{
		Linear,
	...
	public delegate void OnFinished (NGUITweener tween);
	...
	public void Sample (float factor, bool isFinished)
	{
        ...
        else if (method == Method.SquareOut)
        {
            val = 1 - val;
            val = val * val;
            val = 1 - val;
        }
        else if (method == Method.CubicOut)
        {
            val = 1 - val;
            val = val * val * val;
            val = 1 - val;
	...
	static public T Begin<T> (GameObject go, float duration) where T : NGUITweener
	{
