...
public class NGUIDragObject : IgnoreTimeScale
{
	...
	void OnPress (bool pressed)
	{
		if (enabled && NGUITools.GetActive(gameObject) && target != null)
		{
			...
			else if (restrictWithinPanel && mPanel.clipping != NGUIDrawCall.Clipping.None && dragEffect == DragEffect.MomentumAndSpring)
			{
		...
		if (enabled && NGUITools.GetActive(gameObject) && target != null)
		{
			...
			if (mPlane.Raycast(ray, out dist))
			{
				...
				if (restrictWithinPanel)
				{
					...
					if (dragEffect != DragEffect.MomentumAndSpring && mPanel.clipping != NGUIDrawCall.Clipping.None &&
