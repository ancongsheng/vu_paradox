...
public class NGUIButtonScale : MonoBehaviour
{
	...
	void OnHover (bool isOver)
	{
		...
		{
			if (!mStarted) Start();
			TweenScale.Begin(tweenTarget.gameObject, duration, isOver ? Vector3.Scale(mScale, hover) : mScale).method = NGUITweener.Method.EaseInOut;
			mHighlighted = isOver;
		}
	}
}
