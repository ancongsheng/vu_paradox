...
public class NGUIDragCamera : IgnoreTimeScale
{
	/// <summary>
	/// Target object that will be dragged.
	/// </summary>

	public NGUIDraggableCamera draggableCamera;
	...
	void Awake ()
	{
		...
		if (target != null)
		{
			...
			{
				draggableCamera = target.GetComponent<NGUIDraggableCamera>();

				if (draggableCamera == null)
				{
					draggableCamera = target.gameObject.AddComponent<NGUIDraggableCamera>();
				}
			}
			target = null;
		}
		...
		{
			draggableCamera = NGUITools.FindInParents<NGUIDraggableCamera>(gameObject);
		}
	}
