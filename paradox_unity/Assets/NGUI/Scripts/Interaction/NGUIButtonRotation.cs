...
public class NGUIButtonRotation : MonoBehaviour
{
	...
	void OnHover (bool isOver)
	{
		...
		{
			if (!mStarted) Start();
			TweenRotation.Begin(tweenTarget.gameObject, duration, isOver ? mRot * Quaternion.Euler(hover) : mRot).method = NGUITweener.Method.EaseInOut;
			mHighlighted = isOver;
		}
	}
}
