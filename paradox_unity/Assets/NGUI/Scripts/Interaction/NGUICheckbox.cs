...
public class NGUICheckbox : MonoBehaviour
{
	static public NGUICheckbox current;
	...
	/// </summary>
    /// 
    public float checkDuration = 0.2f;
	...
	void OnClickX () { if (enabled) isChecked = !isChecked; }
