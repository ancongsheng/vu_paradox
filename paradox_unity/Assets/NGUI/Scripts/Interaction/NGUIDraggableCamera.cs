...
/// <summary>
/// Works together with NGUIDragCamera script, allowing you to drag a secondary camera while keeping it constrained to a certain area.
/// </summary>

[RequireComponent(typeof(Camera))]
[AddComponentMenu("NGUI/Interaction/Draggable Camera")]
public class NGUIDraggableCamera : IgnoreTimeScale
{
	/// <summary>
	...
	public NGUIDragObject.DragEffect dragEffect = NGUIDragObject.DragEffect.MomentumAndSpring;
	...
	void Start () { mRoot = NGUITools.FindInParents<NGUIRoot>(gameObject); }
	...
	public void Press (bool isPressed)
	{
		...
		if (rootForBounds != null)
		{
			...
			else if (dragEffect == NGUIDragObject.DragEffect.MomentumAndSpring)
			{
	...
	public void Drag (Vector2 delta)
	{
		...
		if (dragEffect != NGUIDragObject.DragEffect.MomentumAndSpring && ConstrainToBounds(true))
		{
			mMomentum = Vector2.zero;
			mScroll = 0f;
		}
	...
	void Update ()
	{
		...
		else
		{
			...
			if (mMomentum.magnitude > 0.01f)
			{
				...
				if (!ConstrainToBounds(dragEffect == NGUIDragObject.DragEffect.None))
				{
					SpringPosition sp = GetComponent<SpringPosition>();
					if (sp != null) sp.enabled = false;
				}
