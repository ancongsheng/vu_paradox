...
[CustomEditor(typeof(XUISlicedSpriteWithGradient))]
public class XUISlicedSpriteWithGradientInspactor : NGUISlicedSpriteInspector
{
    protected XUISlicedSpriteWithGradient mSpriteGradient;
    ...
    {
        mSpriteGradient = mWidget as XUISlicedSpriteWithGradient;
        ...
        if (base.DrawProperties())
        {
            ...
            XUISlicedSpriteWithGradient.GradientDirection dir = (XUISlicedSpriteWithGradient.GradientDirection)EditorGUILayout.EnumPopup("Direction", mSpriteGradient.gradientDirection);
